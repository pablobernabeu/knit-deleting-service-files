...
NOTE: If the user accepts the deletion of the files, the function deletes them irreversibly using `unlink()`. Therefore, our familiar adage truly applies: this function comes with ABSOLUTELY NO WARRANTY.
